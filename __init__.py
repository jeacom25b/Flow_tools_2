...
def add_envelope_armature(self, context):
    self.layout.operator("f_tools_2.add_envelope_armature", text = "Envelope Bone", icon = "BONE_DATA")
...
def register():
    try: 
        ...
        bpy.types.Scene.slash_is_ciclic = bpy.props.BoolProperty(
            name = "Ciclic",
...
def unregister():
    try: 
        ...
        del bpy.types.Scene.slash_is_ciclic
